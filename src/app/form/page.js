...
export default function Page() {
    ...
    const modelArray = ['xgboost_model', 'svr_model', 'linear_regression_model', 'knn_model'];
    ...
    if (submitted) {
        return (
            <div>
                <div style={{textAlign:'center',marginTop:'30px',fontWeight:'600px',fontSize:'30px'}}>Predicted Output</div>
  ...
  <div style={{ flexGrow: 1, overflowY: 'auto', height: '100vh' }}>
    ...
    return (
        <div className="container mx-auto p-6">
            <div style={{textAlign:'center',fontSize:'30px',fontWeight:'600'}}>Socculator</div>
            {loading && (
